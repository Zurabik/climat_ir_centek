...
SetFanMode = Centek09_ns.enum("SetFanMode")
SETFANMODE = {
    "quiet_4levels": SetFanMode.CENTEK09_FAN_Q4L,
    #    "5levels": SetFanMode.CENTEK09_FAN_5L,
    "4levels": SetFanMode.CENTEK09_FAN_4L,
    "3levels": SetFanMode.CENTEK09_FAN_3L,
}
...
HorizontalDirections = Centek09_ns.enum("HorizontalDirections")
...
VerticalDirections = Centek09_ns.enum("VerticalDirections")
VERTICAL_DIRECTIONS = {
...
CONFIG_SCHEMA = climate_ir.climate_ir_with_receiver_schema(Centek09Climate).extend(
    {
